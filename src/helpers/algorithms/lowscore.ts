...
/**
 * This algorithm will look at the board in binary and makes the move that yields the lowest number.
 */
export function lowscoreMove(algorithmVars: AlgorithmVars) {
    ...
    const maxScore = Math.min(...moveScores);
